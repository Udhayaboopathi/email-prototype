...
for api_prefix in ("/api", "/api/v1"):
    ...
    app.include_router(domain_admin.router, prefix=api_prefix)
    ...
    app.include_router(cal_router.router, prefix=api_prefix)
    app.include_router(tasks_router.router, prefix=api_prefix)
    app.include_router(notes_router.router, prefix=api_prefix)
    app.include_router(ai_router.router, prefix=api_prefix)
    app.include_router(pgp.router, prefix=api_prefix)
    app.include_router(campaigns.router, prefix=api_prefix)
    app.include_router(webhooks.router, prefix=api_prefix)
    app.include_router(api_keys.router, prefix=api_prefix)
    app.include_router(send_api.router, prefix=api_prefix)
    app.include_router(tracking.router, prefix=api_prefix)
    app.include_router(shared_mailboxes.router, prefix=api_prefix)
    app.include_router(delegation.router, prefix=api_prefix)
    app.include_router(spam_reports.router, prefix=api_prefix)
    app.include_router(ediscovery.router, prefix=api_prefix)
